                ...
                {relatedProducts.map((product) => (
                  <SwiperSlide key={product.id}>
                    <Link to={`/${product.slug}`} onClick={scrollToTop}>
                      <div className="cursor-pointer min-w-[200px] min-h-[350px] shadow-lg mt-5 mb-10 bg-white p-3 relative rounded-lg overflow-hidden group border-2 border-[#f2f2f2] text-left ">
                        <img alt={product.photo} src={product.photo} className="mt-5 mb-3 max-w-[180px] ml-auto mr-auto shadow-lg" />
